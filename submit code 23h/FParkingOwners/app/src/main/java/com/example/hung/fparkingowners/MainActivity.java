        ...
        if (extras != null) {
            if (extras.containsKey("NotificationMessage")) {
                ...
                if (msg.contains("order")) {
                    createNotification("order","Xe " + pref.getString("licensePlate", "") + " muốn đặt chỗ");
                    createDialog("order");
...
//            editor.putInt("bookingID", b.getBookingID());
    ...
    class UpdateBooingSpaceTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            HttpHandler httpHandler = new HttpHandler();
            try {
                Log.e("Update-Async space", b.toString());
                JSONObject formData = new JSONObject();
...
//                                    System.out.println(formatter.format(4.0));
    ...
    public void changeSpaceButtonClick(View view) {
        ...
        View promptsView = li.inflate(R.layout.ChangeSpace, null);
                ...
                .setPositiveButton("Đồng ý",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,int id) {
                                ...
                                // edit text
                                new UpdateBooingSpaceTask(userInput.getText().toString(),"Manul").equals((Void)null);
